...
<report name="tiskova_sestava" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="TISKOVA_SESTAVA" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select canParse="no">
      <![CDATA[SELECT PRIJMENI, JMENO, OS_CISLO, DATUM_OD, DATUM_DO, PLATBA
FROM POBYT
INNER JOIN KLIENT ON (POBYT.VLASTNIK = KLIENT.OS_CISLO);]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_PRIJMENI">
        <displayInfo x="1.37732" y="1.94995" width="1.24548" height="0.77246"
        />
        <dataItem name="OS_CISLO" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Osobní číslo">
          <dataDescriptor expression="OS_CISLO"
           descriptiveExpression="OS_CISLO" order="3" oracleDatatype="number"
           width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PRIJMENI" datatype="vchar2" columnOrder="11"
         width="25" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Příjmení">
          <dataDescriptor expression="PRIJMENI"
           descriptiveExpression="PRIJMENI" order="1" width="25"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="JMENO" datatype="vchar2" columnOrder="12" width="25"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Jméno">
          <dataDescriptor expression="JMENO" descriptiveExpression="JMENO"
           order="2" width="25"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="SumPLATBAPerOS_CISLO" source="PLATBA" function="sum"
         width="22" scale="-127" reset="G_PRIJMENI" compute="report"
      ...
      <group name="G_DATUM_OD">
        <displayInfo x="1.37732" y="3.49951" width="1.24548" height="0.77246"
        />
        <dataItem name="DATUM_OD" datatype="character" columnOrder="14"
         width="255" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Datum Od">
          <dataDescriptor expression="DATUM_OD"
           descriptiveExpression="DATUM_OD" order="4" width="255" scale="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DATUM_DO" datatype="character" columnOrder="15"
         width="255" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Datum Do">
          <dataDescriptor expression="DATUM_DO"
           descriptiveExpression="DATUM_DO" order="5" width="255" scale="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PLATBA" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="20000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Platba">
          <dataDescriptor expression="PLATBA" descriptiveExpression="PLATBA"
           order="6" width="22" scale="-127"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="SumPLATBAPerReport" source="PLATBA" function="sum"
  ...
  <section name="main">
    <body>
      <frame name="M_G_PRIJMENI_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="5.12500" height="1.56250"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_PRIJMENI" source="G_PRIJMENI"
         printDirection="down" minWidowRecords="1" columnMode="no"
         vertSpaceBetweenFrames="0.1250">
          <geometryInfo x="0.00000" y="0.62500" width="5.12500"
           height="0.81250"/>
          <generalLayout verticalElasticity="variable"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableCell"/>
          <field name="F_OS_CISLO" source="OS_CISLO" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.87500" y="0.62500" width="0.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <frame name="M_G_DATUM_OD_GRPFR">
            <geometryInfo x="0.00000" y="0.81250" width="5.12500"
             height="0.62500"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_DATUM_OD" source="G_DATUM_OD"
             printDirection="down" minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.00000" y="1.00000" width="5.12500"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              <field name="F_DATUM_OD" source="DATUM_OD" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="0.00000" y="1.00000" width="2.31250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_DATUM_DO" source="DATUM_DO" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="2.31250" y="1.00000" width="2.25000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_PLATBA" source="PLATBA" minWidowLines="1"
               spacing="0" alignment="end">
                <font face="helvetica" size="10"/>
                <geometryInfo x="4.68750" y="1.00000" width="0.43750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_DATUM_OD_FTR">
              <geometryInfo x="0.00000" y="1.18750" width="5.12500"
               height="0.25000"/>
              <advancedLayout printObjectOnPage="lastPage"
               basePrintingOn="anchoringObject"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="Totals"/>
              <field name="F_SumPLATBAPerOS_CISLO"
               source="SumPLATBAPerOS_CISLO" minWidowLines="1" spacing="0"
               alignment="end">
                <font face="helvetica" size="10" bold="yes"
                 textColor="TextColor"/>
                <geometryInfo x="4.68750" y="1.18750" width="0.43750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand">
                  <conditionalFormat>
                    <formatException
                     label="(:SumPLATBAPerOS_CISLO = &apos;0&apos;)">
                      <font face="helvetica" size="10" bold="yes"
                       textColor="TextColor"/>
                    <cond name="first" column="SumPLATBAPerOS_CISLO"
                     exception="1" lowValue="0" conjunction="2"/>
                    </formatException>
                    <formatException
                     label="(:SumPLATBAPerOS_CISLO &gt; &apos;0&apos;)">
                      <font face="helvetica" size="10" bold="yes"/>
                    <cond name="first" column="SumPLATBAPerOS_CISLO"
                     exception="3" lowValue="0" conjunction="1"/>
                    </formatException>
                  </conditionalFormat>
                </generalLayout>
                <advancedLayout formatTrigger="f_sumplatbaperos_cisloformattr"
                />
              </field>
              <text name="B_Total_" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="0.00000" y="1.18750" width="0.43750"
                 height="0.18750"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
                   textColor="TextColor"/>
            ...
            <frame name="M_G_DATUM_OD_HDR">
              ...
              <text name="B_DATUM_OD" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="0.00000" y="0.81250" width="2.31250"
                 height="0.18750"/>
              ...
              <text name="B_DATUM_DO" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="2.31250" y="0.81250" width="2.25000"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_PLATBA" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="4.68750" y="0.81250" width="0.43750"
                 height="0.18750"/>
          ...
          <text name="B_OS_CISLO" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <field name="F_PRIJMENI" source="PRIJMENI" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="1.81250" y="0.62500" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <text name="B_PRIJMENI" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.18750" y="0.62500" width="0.62500"
             height="0.18750"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
          ...
          <field name="F_JMENO" source="JMENO" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="3.68750" y="0.62500" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <text name="B_JMENO" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.18750" y="0.62500" width="0.50000"
             height="0.18750"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
        ...
        <text name="B_1" minWidowLines="1">
          ...
          <geometryInfo x="0.75000" y="0.00000" width="2.84375"
           height="0.60413"/>
          <visualSettings fillBackgroundColor="r100g100b100"/>
          <textSegment>
            <font face="helvetica" size="36" bold="yes"/>
            <string>
            <![CDATA[Klienti]]>
            </string>
          </textSegment>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <programUnits>
    <function name="f_sumplatbaperos_cisloformattr">
      <textSource>
      <![CDATA[function F_SumPLATBAPerOS_CISLOFormatTr return boolean is
begin

  -- Automatically Generated from Reports Builder.
  if (:SumPLATBAPerOS_CISLO = '0')
  then
    return (TRUE);
  end if;
...
<rw:dataArea id="MGPRIJMENIGRPFR236">
<rw:foreach id="RGPRIJMENI2361" src="G_PRIJMENI">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader">  <br>Osobní cislo <rw:field id="F_OS_CISLO" src="OS_CISLO" breakLevel="RGPRIJMENI2361" breakValue="&nbsp;"> F_OS_CISLO </rw:field><br>
Prijmeni <rw:field id="F_PRIJMENI" src="PRIJMENI" breakLevel="RGPRIJMENI2361" breakValue="&nbsp;"> F_PRIJMENI </rw:field><br>
Jmeno <rw:field id="F_JMENO" src="JMENO" breakLevel="RGPRIJMENI2361" breakValue="&nbsp;"> F_JMENO </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    ...
    <table class="OraTable" summary="">
     ...
     <thead>
      <tr>
       <th <rw:id id="HBDATUMOD236" asArray="no"/> class="OraColumnHeader"> Datum Od </th>
       <th <rw:id id="HBDATUMDO236" asArray="no"/> class="OraColumnHeader"> Datum Do </th>
       <th <rw:id id="HBPLATBA236" asArray="no"/> class="OraColumnHeader"> Platba </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGDATUMOD2361" src="G_DATUM_OD">
       <tr>
        <td <rw:headers id="HFDATUMOD236" src="HBDATUMOD236"/> class="OraCellText"><rw:field id="FDATUMOD236" src="DATUM_OD" nullValue="&nbsp;"> F_DATUM_OD </rw:field></td>
        <td <rw:headers id="HFDATUMDO236" src="HBDATUMDO236"/> class="OraCellText"><rw:field id="FDATUMDO236" src="DATUM_DO" nullValue="&nbsp;"> F_DATUM_DO </rw:field></td>
        <td <rw:headers id="HFPLATBA236" src="HBPLATBA236"/> class="OraCellNumber"><rw:field id="FPLATBA236" src="PLATBA" nullValue="&nbsp;"> F_PLATBA </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
      ...
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFSumPLATBAPerOSCISLO236" src="HBPLATBA236"/> class="OraTotalNumber">Total: <rw:field id="FSumPLATBAPerOSCISLO236" src="SumPLATBAPerOS_CISLO" nullValue="&nbsp;"> F_SumPLATBAPerOS_CISLO </rw:field></td>
     </tr>
     <tr>
     </tr>
    </table>
...
<table class="OraTable" summary="">
 <tr>
  <th class="OraTotalNumber"> Total: <rw:field id="F_SumPLATBAPerReport" src="SumPLATBAPerReport" nullValue="&nbsp;"> F_SumPLATBAPerReport </rw:field></th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGPRIJMENIGRPFR236" -->
